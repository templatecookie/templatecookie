<template>
  <div id="tabs" class="py-40 flex">
    <div class="tabs w-40 bg-gray-f5 p-3 flex-shrink-0">
      ...
      <a
        class="block mb-2 tab-left-thumb cursor-pointer"
        v-on:click="activetab = '1'"
        v-bind:class="[activetab === '1' ? 'active' : '']"
        ><img
          class="w-full h-full object-cover"
          src="~@/assets/images/all-img/tab1.png"
          alt=""
      /></a>
      <a
        class="block mb-2 tab-left-thumb cursor-pointer"
        ...
        ><img
          class="w-full h-full object-cover"
          src="~@/assets/images/all-img/2.png"
          alt=""
      /></a>
      <a
        class="block mb-2 tab-left-thumb cursor-pointer"
        ...
        ><img
          class="w-full h-full object-cover"
          src="~@/assets/images/all-img/3.png"
          alt=""
      /></a>
      <a
        class="block mb-2 tab-left-thumb cursor-pointer"
      ...
      <a
        ...
        v-bind:class="[activetab === '11' ? 'active' : '']"
        ><img
          class="w-full h-full object-cover"
          src="~@/assets/images/all-img/tab1.png"
          alt=""
      ...
      <a
        ...
        v-bind:class="[activetab === '12' ? 'active' : '']"
        ><img
          class="w-full h-full object-cover"
          src="~@/assets/images/all-img/tab1.png"
          alt=""
      ...
      <a
        ...
        v-bind:class="[activetab === '13' ? 'active' : '']"
        ><img
          class="w-full h-full object-cover"
          src="~@/assets/images/all-img/tab1.png"
          alt=""
      ...
      <a
        ...
        v-bind:class="[activetab === '14' ? 'active' : '']"
        ><img
          class="w-full h-full object-cover"
          src="~@/assets/images/all-img/tab1.png"
          alt=""
