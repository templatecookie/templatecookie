          ...
          <div class="mx-auto max-w-7xl">
            <div class="lg:grid lg:grid-cols-12 lg:gap-8">
              <div class="px-4 sm:px-6 sm:text-center md:mx-auto md:max-w-2xl lg:col-span-6 lg:flex lg:items-center lg:text-left">
                <div>
                  <a href="#" class="inline-flex items-center rounded-full bg-blue-300 p-1 px-3 pr-2 text-black hover:bg-blue-500 text-sm">
            ...
            <div class="pt-6">
              <div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                <div class="-mt-6">
                  ...
                  <h3 class="mt-8 text-lg font-semibold leading-8 tracking-tight text-gray-900">Product Design (UI/UX)</h3>
            ...
            <div class="pt-6">
              <div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                <div class="-mt-6">
                  ...
                  <h3 class="mt-8 text-lg font-semibold leading-8 tracking-tight text-gray-900">Custom Software Development</h3>
                  <p class="mt-5 text-base leading-7 text-gray-600">Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</p>
                </div>
              </div>
            </div>
            ...
            <div class="pt-6">
              <div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                <div class="-mt-6">
                  ...
                  <h3 class="mt-8 text-lg font-semibold leading-8 tracking-tight text-gray-900">Online Marketplace Development</h3>
                  <p class="mt-5 text-base leading-7 text-gray-600">Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</p>
                </div>
              </div>
            </div>
            ...
            <div class="pt-6">
              <div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                <div class="-mt-6">
                  ...
                  <h3 class="mt-8 text-lg font-semibold leading-8 tracking-tight text-gray-900">MVP Development</h3>
                  <p class="mt-5 text-base leading-7 text-gray-600">Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</p>
                </div>
              </div>
            </div>
            ...
            <div class="pt-6">
              <div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
                <div class="-mt-6">
                  ...
                  <h3 class="mt-8 text-lg font-semibold leading-8 tracking-tight text-gray-900">SAAS Development</h3>
                  <p class="mt-5 text-base leading-7 text-gray-600">Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis.</p>
                </div>
              </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div class="">
            <div class="mb-8 text-center">
              ...
              <p class="mt-3 mx-auto max-w-3xl text-lg text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et, egestas tempus tellus etiam sed. Quam a scelerisque amet ullamcorper eu enim et fermentum, augue.</p>
            </div>
