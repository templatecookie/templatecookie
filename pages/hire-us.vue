<template>
<div>
    <div class="bg-gray-f0 py-20 lg:py-30">
      <div class="container">
        <div class="text-center max-w-4xl	m-auto mb-28">
          ...
          <nuxt-link to="/" class="inline-block bg-blue-0b rounded-br7 py-4 px-9 text-body-17 text-white duration-300 hover:bg-dark-06">Let’s Work together <img class="inline-block ml-2" src="~/assets/images/svg/arrow-right.svg" alt="brand-logo" /></nuxt-link>
        </div>
      </div>
    </div>
    ...
    <div class="bg-orange-ff py-20 lg:py-30">
        <div class="container">
          <div class="lg:max-w-680 m-auto text-center mb-16">
           ...
           <p class="text-dark-06 text-lg sm:text-lg mb-6 lg:mb-9">Phasellus interdum sagittis magna. Donec varius ultricies diam sed lacinia. Mauris porttitor. quis risus eget mattis Ut auctor.</p>
          </div>
          <div class="grid grid-cols-12 gap-6">
      ...
      <div class="container">
        ...
        <div class="max-w-872 m-auto grid grid-cols-12 gap-6">
            <div class="col-span-12 lg:col-span-6 md:col-span-6 sm:col-span-6">
              <div class="rounded-xl p-6 md:p-8 shadow-bs08 border border-gray-e6">
                <div class="mb-8">
