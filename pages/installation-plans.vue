      ...
      <div class="container py-[124px]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          <div class>
            ...
            <label for="first">
              <div class="flex items-center gap-3 rounded-xl p-5" :class="picked == 'first' ? 'border-2 border-[#0B63E5] bg-white': 'bg-[#F5F6F7] border-2 border-transparent'">
                <div>
                  <img src="../assets/images/all-img/product-1.png" alt />
                </div>
    ...
    <section class="pricing-section bg-white">
      <div class="container">
        ...
        <div class="card-area m-auto justify-center flex-wrap flex gap-6 mb-6">
          <div class="card bg-white p-8 rounded-2xl border border-gray-100 border-t-4 border-t-[#FF8800] max-w-[424px]">
