      ...
      <div class="mx-auto max-w-7xl py-20 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          ...
          <p class="text-lg md:text-lg text-dark max-w-full md:max-w-[536px] mx-auto font-light">
            ...
            <a class="text-blue-600" href="https://1.envato.market/EaNJ2X">codecanyon profile</a>
          </p>
        </div>
      </div>
    </section>
...
const selectedProductData = computed(() => {
  return products.value.find((elem) => {
    return (
      elem.product.id ===
      (selectedProduct.value ? selectedProduct.value.replace("id", "") : null)
    );
  });
});
...
const title = "Streamlined Installation Plans | TemplateCookie";
const description =
  "Buy our premium installation support package. The TemplateCookie expert team will help you get your app installed & configured.";
