          ...
          <div class="space-y-6 lg:space-y-10">
            <div class="flex">
              ...
              <div class="ml-5 sm:ml-8">
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                  Don't let your new ideas slow you down. Our team of experts are capable of processing your new ideas into working feature at a rocket speed.
                </p>
              </div>
            </div>
            <!-- End Icon Block -->
            ...
            <div class="flex">
              ...
              <div class="ml-5 sm:ml-8">
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                  Leave the maintenance to us. We'll keep your scripts optimized and secure, so you can focus on what matters most.
                </p>
              </div>
            </div>
            <!-- End Icon Block -->
