        ...
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
          <div class="max-w-2xl text-center mx-auto">
            ...
            <div class="mt-5 max-w-3xl">
              <p class="text-lg text-gray-600 dark:text-gray-400 mb-4">At Templatecookie, we believe in the transformative power of digital solutions. We are more than a web and software development company; we are your trusted partner on the journey to success. Our mission is to empower businesses, both large and small, with innovative technology that drives growth, efficiency, and user satisfaction.</p>
              <p class="text-lg text-gray-600 dark:text-gray-400">With a strong commitment to quality and a dedicated team of experts, Templatecookie is here to turn your digital dreams into reality. We pride ourselves on being a reliable source for all your web development, software solutions, and customization needs.</p>
            </div>
