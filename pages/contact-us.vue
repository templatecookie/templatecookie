          ...
          <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
            <div>
              ...
              <p class="mt-4 leading-7 text-gray-600">
                Celebrate Your Digital Success with Us. Reach out for questions or assistance. We're here to help you thrive in the digital world.
              </p>
            </div>
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8">
              <div class="rounded-2xl bg-gray-50 p-10">
                ...
                <dl class="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                  <div>
                    ...
                    <dd><a class="font-semibold text-indigo-600" href="mailto:support@templatecookie.com">support@templatecookie.com</a></dd>
                  </div>
                  <div class="mt-1">
              ...
              <div class="rounded-2xl bg-gray-50 p-10">
                <h3 class="text-base font-semibold leading-7 text-gray-900">Phone</h3>
                <dl class="mt-3 space-y-1 text-sm leading-6 text-gray-600">
                  <div>
                    <dt class="sr-only">Email</dt>
                    <dd><a class="font-semibold text-indigo-600" href="tel:01610774060">
                      880 (1610) 774-060
                    </a></dd>
                  </div>
                  <div class="mt-1">
          ...
          <div class="mt-20 flex pt-4">
            <div class="flex gap-x-6">
              ...
              <div>
                ...
                <p class="mt-4">
                  <a href="#" class="text-sm font-semibold leading-6 text-indigo-600">Contact us <span aria-hidden="true">&rarr;</span></a>
                </p>
              </div>
            </div>
            <div class="flex gap-x-6">
              ...
              <div>
                ...
                <p class="mt-2 leading-7 text-gray-600">Expedita qui non ut quia ipsum voluptatum ipsam pariatur. Culpa vitae ipsum minus eius vero quo quibusdam.</p>
                <p class="mt-4">
            ...
            <div class="flex gap-x-6">
              ...
              <div>
                ...
                <p class="mt-2 leading-7 text-gray-600">Sint aut modi porro consequatur architecto commodi qui consequatur. Dignissimos adipisci minima.</p>
                <p class="mt-4">
...
const title = "Contact Us | Templatecookie - Get in Touch with Your Digital Partner";
const description = "Have questions or need assistance? Contact Templatecookie, your digital partner. We're here to help you succeed. Reach out today.";
