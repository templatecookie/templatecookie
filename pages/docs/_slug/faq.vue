    ...
    <div class="px-6 pb-0 w-8/12 h-full">
      ...
      <div class="mt-12 lg:col-span-2 lg:mt-0">
        <dl class="space-y-12 markdown-body">
          <div>
            <dt class="text-lg font-medium leading-6 text-gray-900">Emails are not sending / I have errors with my SMTP.</dt>
            <dd class="mt-2 text-base text-gray-500">All errors related to the email sending system are caused by either: Incorrect SMTP credentials, not properly working SMTP server, or web host blocking the actual SMTP connection. For any of these issues, contact your SMTP or web host provider.</dd>
          </div>
          <div>
