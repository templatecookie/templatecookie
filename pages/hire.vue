    ...
    <!-- HTML -->
      <section class="bg-gray-300 py-12">
        <div class="container mx-auto px-4">
          <h2 class="text-3xl font-bold text-center mb-6">Our Working Process</h2>
          <div class="flex flex-col md:flex-row justify-between">
            <div class="w-full md:w-1/3 px-4 mb-6 md:mb-0">
              <div class="bg-white rounded-lg shadow-lg p-6">
                <h3 class="text-xl font-bold mb-4">Step 1</h3>
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent at risus vel justo tempor egestas.</p>
                <div class="flex items-center">
                  <svg class="h-6 w-6 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                  <span class="text-gray-600">Learn more</span>
                </div>
              </div>
            </div>
            <div class="w-full md:w-1/3 px-4 mb-6 md:mb-0">
