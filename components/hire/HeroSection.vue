<template>
  <div class="relative overflow-hidden bg-gray-800">
    ...
    <div class="mx-auto max-w-7xl py-20 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
      ...
      <div class="w-full mt-12 mx-auto md:w-2/5">
        <div
          ...
          <h3 class="mb-6 text-2xl font-medium text-center">Hire Us</h3>
          <form accept-charset="UTF-8"
            action="https://pbj887.infusionsoft.com/app/form/process/a686c8c396862f4b1d3fd2e84ff2f89f"
            ...
            <div class="flex flex-col gap-4">
              <div class="flex gap-5 items-center">
                <div class="infusion-field w-full">
                  <label for="inf_field_FirstName" class="flex mb-1.5 text-sm">First Name <span class="text-sx text-red-600">*</span></label>
                  <input id="inf_field_FirstName" name="inf_field_FirstName" class="transition-all duration-300 rounded-md hover:bg-gray-50 focus:bg-gray-50" placeholder="First Name" type="text" />
                </div>
                <div class="infusion-field w-full">
                  <label for="inf_field_LastName" class="flex mb-1.5 text-sm">Last Name <span class="text-sx text-red-600">*</span></label>
                  <input id="inf_field_LastName" name="inf_field_LastName" placeholder="Last Name" class="transition-all duration-300 rounded-md hover:bg-gray-50 focus:bg-gray-50" type="text" />
                </div>
              </div>
              <div class="flex gap-5 items-center">
                <div class="infusion-field w-full">
                  <label for="inf_field_Email" class="flex mb-1.5 text-sm">Email <span class="text-sx text-red-600">*</span></label>
                  <input id="inf_field_Email" name="inf_field_Email" placeholder="Email" class="transition-all duration-300 w-full rounded-md hover:bg-gray-50 focus:bg-gray-50" type="text" />
                </div>
                <div class="infusion-field w-full">
                  <label for="inf_custom_Chooseyourbudget" class="flex mb-1.5 text-sm">Choose your budget <span class="text-sx text-red-600">*</span></label>
                  <div class="infusion-field-input-container flex">
                    <select id="inf_custom_Chooseyourbudget" class="transition-all duration-300 w-full rounded-md hover:bg-gray-50 focus:bg-gray-50" name="inf_custom_Chooseyourbudget">
              ...
              <div class="infusion-field w-full">
                <label for="inf_custom_Writemessage" class="flex mb-1.5 text-sm">Write message <span class="text-sx text-red-600">*</span></label>
                <textarea id="inf_custom_Writemessage" name="inf_custom_Writemessage"
                  placeholder="Write message" rows="5" class="transition-all duration-300 flex w-full rounded-md hover:bg-gray-50 focus:bg-gray-50"></textarea>
              </div>
              <div class="infusion-submit">
                <button class="infusion-recaptcha bg-primary hover:bg-secondary text-sm text-white rounded-md px-4 py-2" id="recaptcha_a686c8c396862f4b1d3fd2e84ff2f89f"
