    ...
    <div class="container">
      <div class="ex-small:overflow-auto overflow-x-scroll">
          <ul class="flex text-gray-6a text-sm space-x-2 mb-3">
            <li class="leading-3 whitespace-nowrap"><nuxt-link to="/">Home </nuxt-link></li>
            <li class="leading-3 whitespace-nowrap">
              <img src="~@/assets/images/svg/arrow-gray.svg" alt="" />
            </li>
            <li class="leading-3 whitespace-nowrap"><nuxt-link to="/">Product</nuxt-link></li>
            <li class="leading-3 whitespace-nowrap">
              <img src="~@/assets/images/svg/arrow-gray.svg" alt="" />
            </li>
            <li class="leading-3 whitespace-nowrap"><nuxt-link to="/">UI Template</nuxt-link></li>
            <li class="leading-3 whitespace-nowrap">
              <img src="~@/assets/images/svg/arrow-gray.svg" alt="" />
            </li>
            <li class="leading-3 whitespace-nowrap"><nuxt-link to="/">Figma</nuxt-link></li>
          </ul>
      </div>
