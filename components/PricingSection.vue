<template>
  <div class="bg-gray-900 pricing-section" :id="id">
    <div class="relative overflow-hidden pt-24 pb-96 lg:pt-32">
      <div>
        <NuxtImg class="absolute bottom-0 left-1/2 w-full max-w-none -translate-x-1/2"
          src="/grid-blur-purple-on-black.jpg" alt="Teplatecookie Pricing Section Background" />
      </div>
    ...
    <div class="flow-root bg-white pb-32 lg:pb-40">
      <div class="relative -mt-80">
        <div class="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2 lg:gap-8 lg:justify-center">
      ...
      <div class="relative mx-auto mt-8 max-w-7xl px-6 lg:px-8" v-if="requstCustomization">
        <div class="mx-auto max-w-md lg:max-w-4xl">
          <div
            class="flex flex-col gap-6 rounded-3xl p-8 ring-1 ring-gray-900/10 sm:p-10 lg:flex-row lg:items-center lg:gap-8">
            <div class="lg:min-w-0 lg:flex-1">
...
defineProps(["info", "plans", "extraOffer", "id", "requstCustomization"]);
...
watch(isPaddleLoaded, (updatedValue) => {
