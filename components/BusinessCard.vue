<template>
  <div :class="`bg-white rounded-lg p-8 business-card duration-300 hover:shadow-bs8 ${className}`">
    <div
      :class="`icon w-76 h-76 bg-gray-f0 rounded-lg flex items-center justify-center mb-7 duration-300 ${classNameIcon}`">
      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M16.875 16.875H18V24.75H19.125" stroke="#0B63E5" stroke-width="2.5" stroke-linecap="round"
        ...
        <path
          ...
          fill="#0B63E5" stroke="#0B63E5" stroke-width="2.5" />
      </svg>
    </div>
    <div>
      <h3 class="text-dark-06 text-xl mb-3">{{ title }}</h3>
      <p class="text-dark-42 text-base font-light">{{ text }}</p>
    </div>
  </div>
</template>
