...
<div class="relative bg-white">
  <div class="mx-auto max-w-7xl px-4 sm:px-6">
    <div class="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
      ...
      <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0 space-x-4">
        <!-- <a href="#" v-for="(item, index) in mainMenuItems" :key="index" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">{{ item.name }}</a> -->
        <a href="#" v-for="(item, index) in mainMenuItems" :key="index" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">{{ item.name }}</a>
      </div>
    </div>
  </div>
  <div class="mx-auto max-w-7xl px-4 sm:px-6 py-1 pb-4">
    <nav class="hidden md:flex md:justify-between">
      ...
      <div class="flex">
        <a href="#" class="text-sm text-gray-900 bg-gray-100 rounded-xl py-2 px-4">Documentation</a>
      </div>
    </nav>
  </div>
