    ...
    <div class="p-12">
      ...
      <div class="flex flex-col h-full relative mt-16" style="z-index: 10">
        <div>
          ...
          <div
            class="text-5xl leading-tight max-w-4xl text-slate-700"
            style="
