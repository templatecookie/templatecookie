  ...
  <section class="overflow-hidden">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex lg:flex-nowrap flex-wrap px-3 lg:px-0">
        <div
          class="lg:w-1/2 w-full lg:py-[124px] order-2 lg:order-1 pb-14 lg:pb-0 lg:pr-8"
        >
          <h1
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-6">
            <div
              v-for="(item, index) in section.counters"
              :key="index"
              data-aos="zoom-in"
              :data-aos-delay="index * 100"
              class="aos flex flex-col sm:flex-row items-center justify-center sm:justify-start sm:space-x-3 p-6 rounded-xl overflow-hidden bg-primary-100"
              :class="item.cssClass"
            >
              <div>
              ...
              <div class="text-center sm:text-left">
                ...
                <p
                  class="text-sm text-dark-gray uppercase whitespace-nowrap overflow-ellipsis"
                >
                  {{ item.description }}
                </p>
              </div>
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 mt-8 pb-14">
      <div class="flex flex-wrap align-start gap-6">
        <div
          v-for="(item, index) in section.feature"
          :key="index"
          data-aos="fade-up"
          :data-aos-delay="index * 100"
