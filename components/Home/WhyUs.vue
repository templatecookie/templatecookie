    ...
    <div class="flex flex-col lg:grid lg:grid-cols-16 px-3 lg:px-0">
      ...
      <div class="lg:col-start-3 lg:col-end-9 lg:py-124 order-2 lg:order-1 pb-14 lg:pb-0">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-6">
          ...
          <div class="hidden">
            <div v-for="(item, index) in data.counterNumbers" :key="index"
              ...
              <div>
                <span class="inline-block">
                  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                      d="M19.2501 35C25.5324 35 30.6251 29.9072 30.6251 23.625C30.6251 17.3428 25.5324 12.25 19.2501 12.25C12.9679 12.25 7.87512 17.3428 7.87512 23.625C7.87512 29.9072 12.9679 35 19.2501 35Z"
                      stroke="#0F9918" stroke-width="3" stroke-miterlimit="10" />
                    <path
                      ...
                      stroke="#0F9918" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                    <path
              ...
              <div>
                <span>
                  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                      d="M28 49C39.598 49 49 39.598 49 28C49 16.402 39.598 7 28 7C16.402 7 7 16.402 7 28C7 39.598 16.402 49 28 49Z"
                      stroke="#FF8800" stroke-width="3" stroke-miterlimit="10" />
                    <path
                    ...
                    <path
                      ...
                      fill="#FF8800" stroke="#FF8800" stroke-width="3" />
                    <path
                ...
                <span>
                  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                      ...
                      stroke="#F249C8" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                    ...
                    <path
                      ...
                      stroke="#F249C8" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M25.3767 26.25H30.6267" stroke="#F249C8" stroke-width="3" stroke-linecap="round"
      ...
      <div class="lg:col-start-10 lg:col-end-17 order-1 lg:order-2 mb-6 lg:mb-0 h-680 clip-thumb">
        <img src="~assets/images/all-img/img-four.png" alt="" class="w-full h-full object-cover lg:object-fill" />
      </div>
    </div>
  </section>
</template>
