...
<div>
  <footer class="bg-gray-900" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-md pt-12 pb-10 px-4 sm:max-w-lg sm:px-6 sm:pt-16 lg:max-w-7xl lg:px-8 lg:pt-24 lg:pb-10">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="space-y-8 xl:col-span-1">
          <img class="h-10" v-if="footer.logo.url" :src="footer.logo.url" alt="Templatecookie" />
          <img class="h-10" v-else src="~/assets/images/logo.svg" alt="Templatecookie " />
          <p class="text-base text-gray-400">
            {{ footer.description }}
          </p>
          <div class="flex space-x-6" v-if="newsletter[0].socials && newsletter[0].socials">
            <a :href="item.url" class="text-gray-400 hover:text-gray-300" v-for="item in newsletter[0].socials" :key="item.name">
      ...
      <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
        <div class="md:order-2">
          <img class="h-[37px] w-[390px]" src="/static/images/payment.svg" />
        </div>
        <p class="mt-8 text-base text-gray-400 md:order-3 md:mt-0">
